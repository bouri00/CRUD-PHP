...
class Utils 
{
	...
	{ 
		if(! self::$cnx)
		try{
		self::$cnx=new PDO("mysql:host=localhost;dbname=dbphp;charset='utf-8'",'root','', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_DEFAULT_FETCH_MODE=> PDO::FETCH_OBJ));
		return self::$cnx;
		}catch(Exception $e){
